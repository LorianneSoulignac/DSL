...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	 ...
	 * @generated
	 */
	public EReference getTransition_State1() {
	 ...
	 * @generated
	 */
	public EReference getTransition_State2() {
	...
	public void createPackageContents() {
		...
		createEReference(transitionEClass, TRANSITION__STATE1);
		createEReference(transitionEClass, TRANSITION__STATE2);
	...
	public void initializePackageContents() {
		...
		initEClass(transitionEClass, Transition.class, "Transition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransition_State1(), this.getState(), null, "state1", null, 0, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_State2(), this.getState(), null, "state2", null, 0, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
