...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    FSM myFsm = ((FSM) _get);
    fsa.generateFile("FSM.java", this.generateFsmMainClass(myFsm));
    fsa.generateFile("StateAbstr.java", this.generateAbstractState());
    fsa.generateFile("State.java", this.generateNormalState());
  ...
  public String generateTransition() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("public StateAbstr getStateStart() { return this.stateStart; }");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("public StateAbstr getStateEnd() { return this.stateEnd; }");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
  ...
  public String generateAbstractState() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("public StateAbstr(String st){");
    _builder.newLine();
    _builder.append("\t\t\t\t");
  ...
  public String generateFsmMainClass(final FSM fsm) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("System.out.println(\"Etat courant : \" + current.getState());");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("final StateAbstr currentState = current;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("System.out.println(\"Lancer la transition : \");");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
