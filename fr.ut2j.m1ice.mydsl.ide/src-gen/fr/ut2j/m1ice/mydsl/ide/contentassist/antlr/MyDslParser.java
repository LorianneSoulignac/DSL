 ...
 */
package fr.ut2j.m1ice.mydsl.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import fr.ut2j.m1ice.mydsl.ide.contentassist.antlr.internal.InternalMyDslParser;
...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFSMAccess().getTransitionAssignment_7_1(), "rule__FSM__TransitionAssignment_7_1");
			...
			builder.put(grammarAccess.getTransitionAccess().getState1Assignment_3_0(), "rule__Transition__State1Assignment_3_0");
			builder.put(grammarAccess.getTransitionAccess().getState2Assignment_3_2(), "rule__Transition__State2Assignment_3_2");
