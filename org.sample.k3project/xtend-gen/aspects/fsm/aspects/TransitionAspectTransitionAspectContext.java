...
import aspects.fsm.aspects.TransitionAspectTransitionAspectProperties;
...
public class TransitionAspectTransitionAspectContext {
  ...
  public static TransitionAspectTransitionAspectProperties getSelf(final Transition _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new aspects.fsm.aspects.TransitionAspectTransitionAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Transition, TransitionAspectTransitionAspectProperties> map = new java.util.WeakHashMap<fr.ut2j.m1ice.fsm.Transition, aspects.fsm.aspects.TransitionAspectTransitionAspectProperties>();
